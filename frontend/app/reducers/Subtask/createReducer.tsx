...
import { Translation } from '../../translations/Subtask'
import { SnackAction } from "../snackReducer"

export type SubtaskCreateFormState = {
	data: {
		title: string
	}
}
export const getSubtaskCreateFormReducer = (initialState: SubtaskCreateFormState, translation: Translation, dispatchSnack: React.Dispatch<SnackAction>) => {
	return (state: SubtaskCreateFormState, action: any) => {
