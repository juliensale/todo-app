...
export type SubtaskEditFormState = {
	data: {
		title: string
	}
}
export const getSubtaskEditFormReducer = (initialState: SubtaskEditFormState, translation: Translation, dispatchSnack: React.Dispatch<SnackAction>) => {
	return (state: SubtaskEditFormState, action: any) => {
