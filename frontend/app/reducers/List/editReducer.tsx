...
export type ListEditFormState = {
	data: {
		title: string,
		color: string
	}
}
export const getListEditFormReducer = (initialState: ListEditFormState, translation: Translation, dispatchSnack: React.Dispatch<SnackAction>) => {
	return (state: ListEditFormState, action: any) => {
