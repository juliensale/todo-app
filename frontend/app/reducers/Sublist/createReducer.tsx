...
import { Translation } from '../../translations/Sublist'
import { SnackAction } from "../snackReducer"

export type SublistCreateFormState = {
	data: {
		title: string
	}
}
export const getSublistCreateFormReducer = (initialState: SublistCreateFormState, translation: Translation, dispatchSnack: React.Dispatch<SnackAction>) => {
	return (state: SublistCreateFormState, action: any) => {
