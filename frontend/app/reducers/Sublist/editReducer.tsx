...
export type SublistEditFormState = {
	data: {
		title: string
	}
}
export const getSublistEditFormReducer = (initialState: SublistEditFormState, translation: Translation, dispatchSnack: React.Dispatch<SnackAction>) => {
	return (state: SublistEditFormState, action: any) => {
